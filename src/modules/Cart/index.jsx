...
const Cart = () => {
  ...
  if(carts.length === 0) {
    return <div className=' h-[55vh] flex justify-center items-center text-4xl '>Your Cart is Empty</div>
  }
      ...
      <div className="flex shadow-md my-10">
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <div className="py-10">
            ...
            <input type="text" id="promo" placeholder="Enter your code" className="p-2 border-2 text-sm w-full" />
          </div>
